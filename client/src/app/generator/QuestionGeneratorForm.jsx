...
export default function QuestionGeneratorForm() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto my-auto text-[var(--color-text)] font-bold rounded-lg shadow-md bg-[var(--baby-powder)]">
      ...
      <form
        method="POST"
        action={getApiUrl(isLocalhost()) + "/question-gen"}
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Board */}
          <div>
            <label className="block text-2xl font-bold mb-3">📚 Board:</label>
            <select
              name="board"
              value={selectedBoard}
              onChange={(e) => {
              ...
              className="w-full p-2 text-lg border-2 border-[var(--blue-highlight)] rounded-xl focus:outline-none transition-all duration-300"
              required
            >
          ...
          {/* Subject */}
          <div>
            <label className="block text-2xl font-bold mb-3">📖 Subject:</label>
            <select
              name="subject"
          ...
          <div className="relative" ref={topicRef}>
            <label className="block text-2xl font-bold mb-3">🎯 Topics:</label>
            <div
            ...
            >
              ...
              <span className="text-xl">{showTopicDropdown ? "↑" : "↓"}</span>
            </div>
            {showTopicDropdown && (
                  ...
                  return (
                    <label
                      ...
                      className={`flex items-center px-4 py-2 hover:opacity-90 cursor-pointer select-none ${
                        isChecked ? "bg-[var(--blue-highlight)] text-white" : ""
                      } rounded`}
                    >
                      <input
                        type="checkbox"
          ...
          <div className="relative" ref={compRef}>
            <label className="block text-2xl font-bold mb-3">🔧 Components:</label>
            <div
              className="flex items-center justify-between text-lg p-2 border-2 border-[var(--blue-highlight)] rounded-xl focus:outline-none transition-all duration-300 cursor-pointer bg-[var(--baby-powder)]"
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="flex-1">
            <label className="block text-2xl font-bold mb-3">📊 Levels:</label>
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      className="appearance-none absolute opacity-0"
                      onChange={() =>
                        toggleCheckbox(lvl, selectedLevels, setSelectedLevels)
                      }
                    />
                    <span>{lvl}</span>
                  </label>
          ...
          <div className="flex-1">
            <label className="block text-2xl font-bold mb-3">Difficulty:</label>
