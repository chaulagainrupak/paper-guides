...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll('.paper-pdf, .question-image, .solution-image').forEach(element => {
...
async function fetchDocumentData() {
  try {
    ...
    if (data.question) {
      const questionElements = document.querySelectorAll('.question-image, .paper-pdf.question-pdf');
      questionElements.forEach(element => {
        if (element.classList.contains('question-image')) {
          renderImageFromElement(element, data.question);
        } else {
    ...
    if (data.solution) {
      const solutionElements = document.querySelectorAll('.solution-image, .paper-pdf.solution-pdf');
      solutionElements.forEach(element => {
        if (element.classList.contains('solution-image')) {
          renderImageFromElement(element, data.solution);
        } else {
